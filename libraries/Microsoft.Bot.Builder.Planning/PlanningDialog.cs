...
namespace Microsoft.Bot.Builder.Planning
{
    ...
    public class PlanningDialog : Dialog
    {
        ...
        public PlanningDialog(string dialogId = null) 
            : base(dialogId)
        {
        }
        ...
        public void AddRule(IEnumerable<IPlanningRule> rules)
        {
